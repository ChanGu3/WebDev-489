...
function NavbarOS()
{
    ...
    return (
        <>
            {/* --- Navbar --- */}
            <nav id="navbar" className="fixed top-0 left-0 w-full h-12 flex flex-row bg-[#0F0F0F] z-98">
                <div className="flex flex-row items-center z-100">
                    <a id="logo" className="mx-2 px-1 flex flex-row items-center justify-center hover:brightness-0 hover:invert" href="/">
                        ...
                        <p className="text-[#87CEEB] font-bold text-md hidden md:block">OtakuStream</p>
                    </a>
                    ...
                    <div className="relative h-full hidden md:block">
                        <button id="categoriestab" name="categoriestab" className="px-3 flex flex-row items-center justify-center space-x-1 cursor-pointer hover:bg-gray-800 active:bg-gray-700 h-full" type="button" onClick={() => ToggleCategoriesDropDown()}>
                            <p className="text-[#F8F8FF] text-sm">Categories</p>
                        ...
                        <div id="categoriesdropdown" name="categoriesdropdown" className="absolute bg-[#429ABE] p-2 flex flex-row hidden">
                            <div id="genres" className="flex flex-col justify-start">
                                ...
                                <div className="my-1 border-[#F8F8FF] rounded-sm border-b-2 w-[95%]"></div>
                    ...
                    <a id="support" name="support" className="px-3 flex flex-row items-center justify-center space-x-1 cursor-pointer hover:bg-gray-800 active:bg-gray-700 h-full" href="#">
                        <p className="text-[#F8F8FF] text-sm">Support</p>
                    </a>
                    <a id="aboutus" name="aboutus" className="px-3 flex-row items-center justify-center space-x-1 cursor-pointer hover:bg-gray-800 active:bg-gray-700 h-full hidden md:flex" href="#">
                        <p className="text-[#F8F8FF] text-sm">About Us</p>
                    </a>
                </div>
                <div className="relative h-full ml-auto z-100">
                    <button id="profiletab" name="profiletab" className="px-4 flex flex-row items-center justify-center cursor-pointer hover:bg-gray-800 active:bg-gray-700 h-full" type="button" onClick={() => ToggleProfileDropDown()}>
                        <img className="min-w-7 w-7 mr-1 rounded-full border-1 border-[#F8F8FF]" type="image/png" src={tvLogo} alt="os-tv-logo"/>
                        <img className="w-2" src="/triangle-filled-svgrepo-com.svg" alt="dropdown-icon"></img>
                    </button>
                    {/* --- Guest Profile Dropdown --- */}
                    <div id="profiledropdown" name="profiledropdown" className="absolute right-0 w-35 md:w-60 bg-[#429ABE] py-4 px-2 flex flex-col space-y-4 hidden">
                        <a className="flex flex-col py-2 pl-2 pr-4 hover:bg-[#59CFFF] active:bg-[#59CFFF] rounded-xs space-y-0.25" href="/auth/signin">
                            ...
                            <p className="text-xs font-semibold text-[#F8F8FF]">Welcome Back! <span className="hidden md:inline">Can't wait to see what your into now!</span></p>
                        </a>
                        <a className="flex flex-col py-2 pl-2 pr-4 hover:bg-[#59CFFF] active:bg-[#59CFFF] rounded-xs space-y-0.25" href="/auth/signup">
                            ...
                            <p className="text-xs font-semibold text-[#F8F8FF]">Join Us! <span className="hidden md:inline">Watch anime ad free with a premium account!</span></p>
                        </a>
                    </div>
