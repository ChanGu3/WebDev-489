...
function SeriesModule2({isMovie, streamTitle, streamImageSrc, dateReleased, href, episodeNum = 0})
{
        ...
        <div className="relative">
            <a href={href} className="relative flex flex-col space-y-0.5 group">
                ...
                <div className="flex flex-col md:flex-row justify-between">
                    ...
                    <p className="text-os-dark-secondary text-[6px] md:text-[8px] italic font-semibold truncate"><span className="text-os-blue-secondary font-bold ">Released:</span> {dateReleased}</p>
                </div>
            </a>
        </div>
        </>
