...
function SeriesModule({seriesID, title, imageSrc, seasonNum, episodeNum, movieNum, description, href})
{
    ...
    useEffect(() => {
        ...
        const starSVG = starRef.current;
        const starButton = starbuttonRef.current;
            ...
            <div className="absolute top-0 left-0 w-full h-full opacity-0 pointer-events-none md:pointer-events-auto md:hover:opacity-100">
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-os-dark-tertiary/90 flex flex-col px-3 py-1">
                    <div className="w-full flex flex-row justify-between">
                        ...
                        <button ref={starbuttonRef} type="button" onClick={() => { FavoriteSeries(starRef, seriesID) }} className="cursor-pointer">
                            <svg ref={starRef} viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-os-blue-primary w-[24px]">
