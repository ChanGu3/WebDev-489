        ...
        <NavbarOS />
            <div className="flex flex-col items-center justify-center mt-20 space-y-20">
                ...
                <div className="flex flex-col justify-center items-center space-y-6 w-65 md:w-100">
                    <p className="text-center text-[#429ABE] font-bold text-lg md:text-2xl">Account Created Successfully!</p>

                    <div className="flex flex-col items-center space-y-1 w-full">
                        <p className="text-[#F8F8FF] font-semibold text-md md:text-lg">Join Us As A Premium Member!</p>
                        <p className="md:w-[65%] text-center text-[#F8F8FF] font-thin text-xs md:text-sm">Watch anime interrupted! ad free!!!</p>
                    </div>
