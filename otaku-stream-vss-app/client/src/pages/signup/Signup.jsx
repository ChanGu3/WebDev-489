            ...
            <div className="flex flex-col items-center justify-center mt-20 space-y-20">
                ...
                <div className="flex flex-col justify-center items-center space-y-6 w-65 md:w-100">
                    <div className="flex flex-col items-center space-y-1 w-full">
                        ...
                        <p className="md:w-[65%] text-center text-[#F8F8FF] font-thin text-sm">Enter your email and create a password by typing it in twice to sign up as a Otaku Stream Member!</p>
                    </div>
                    ...
                    <p className="md:w-[70%] text-xs text-center text-[#F8F8FF] " href="/auth/signin">By clicking Sign up, you agree to our <a className="text-[#777777] hover:underline cursor-pointer" href="#">Terms of Service</a> and <a className="text-[#777777] hover:underline cursor-pointer" href="#">Privacy Policy</a></p>
                </div>
            </div>
        <FooterOS />
        </>
